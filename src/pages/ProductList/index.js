...
class ProductList extends React.Component {
    ...
    this.state = {
      ...
      products: [
        ...
        },
        {
          ...
          price: 20000000,  
          discount: 0,
          image: 'https://cdn.moladin.com/motor/yamaha/Yamaha_MT_25_2057_73438_thumbnail.jpg',
          rating: 5,
          seller: 'BEST POLYGON',
          location: 'Jakarta',
        },
  ...
  render() {
    ...
    const filteredRating = products.filter(product => {
    ...
    const filteredProducts = filteredRating.filter(product => {
